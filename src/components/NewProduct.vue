        ...
        <div class="col-md-11 card">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" v-model="product.title" class="form-control" placeholder="Enter Product Title">
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        <label>Product Amount</label>
                        <input type="text" v-model="product.count" class="form-control" placeholder="Enter Product Amount">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Product Price</label>
                        <input type="text" v-model="product.price" class="form-control" placeholder="Enter Product Price">
                    </div>
                </div>
